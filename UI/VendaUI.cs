                    ...
                    case 1:
                        ...
                        while (!clienteSelecionado)
                        {
                            ...
                            else
                            {
                                ...
                                foreach (var cliente in ListaDeClientes)
                                {
                                    if (cliente.GetID() == idClienteSelec)
                                    {
                                        //cliente selecionado
                                        clienteSelecionado = true;
                                        _idCliente = cliente.GetID();
                                        Console.WriteLine("Cliente selecionado: " + cliente.GetNome());
                                        Continuar();
                                    }
                                    break;
                                }
            ...
            while (!produtoSelecionado)
            {
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        foreach (var produto in ListaDeProdutos)
                        {
                            if (produto.GetID() == idProdutoSelec)
                            {
                                //produto selecionado
                                _idProduto = produto.GetID();
                                Console.WriteLine("Produto selecionado:" + produto.GetNome());
                                Continuar();
                ...
                else
                {
                    ...
                    switch (opcao)
                    {
                        case 1:
                            ...
                            foreach (var produto in ListaDeProdutos)
                            {
                                if (produto.GetID() == _idProduto)
                                {
                                    produto.SetQuantidade(_quantidade);
                                    produto.SetID(_idProduto);
